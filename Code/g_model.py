        ...
        if global_step % c.IMG_SAVE_FREQ == 0:
            ...
            for pred_num in range(len(input_frames)):
                ...
                for frame_num in range(c.HIST_LEN):
                    ...
                    Image.fromarray(img).save(os.path.join(pred_dir, 'input_' + str(frame_num) + '.png'))
                ...
                for scale_num, scale_pred in enumerate(scale_preds):
                    ...
                    Image.fromarray(gen_img).save(path + '_gen.png')
                    Image.fromarray(gt_img).save(path + '_gt.png')
        ...
        if save_imgs:
            for pred_num in range(len(input_frames)):
                ...
                for rec_num in range(num_rec_out):
                    ...
                    Image.fromarray(gen_img).save(os.path.join(pred_dir, 'gen_' + str(rec_num) + '.png'))
                    Image.fromarray(gt_img).save(os.path.join(pred_dir, 'gt_' + str(rec_num) + '.png'))
